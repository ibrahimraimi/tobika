 ...
 * Create list item
 */
export const postListItem = (postListItemBody: PostListItemBody, signal?: AbortSignal) => {
...
export const getPostListItemMutationOptions = <TError = unknown, TContext = unknown>(options?: {
...
export const usePostListItem = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postListItem>>,
    TError,
    { data: PostListItemBody },
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getListItemsByListId>>, TError, TData>
    >
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getListItemsByListId>>> = ({ signal }) =>
    getListItemsByListId(listId, params, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getListItemsByListId>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getDeleteListItemIdMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const useDeleteListItemId = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteListItemId>>,
    TError,
    { id: string },
...
export const getUpdateListItemsPositionsMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateListItemsPositionsMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateListItemsPositions>>
>
...
export const useUpdateListItemsPositions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateListItemsPositions>>,
    TError,
    { data: UpdateListItemsPositionsBody },
