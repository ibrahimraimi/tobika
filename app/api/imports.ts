...
export const getPostImportMutationOptions = <TError = PostImport422, TContext = unknown>(options?: {
...
export const usePostImport = <TError = PostImport422, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postImport>>,
    TError,
    { data: PostImportBody; params: PostImportParams },
 ...
 * Get detailed import
 */
export const getImportImportId = (importId: string, signal?: AbortSignal) => {
  return axiosInstance<GetImportImportId200>({ url: `/import/${importId}`, method: 'GET', signal })
}
...
export const getGetImportImportIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getImportImportId>>,
  TError = GetImportImportId404,
>(
  importId: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getImportImportId>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getImportImportId>>> = ({ signal }) =>
    getImportImportId(importId, signal)
...
export type GetImportImportIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getImportImportId>>
>
export type GetImportImportIdQueryError = GetImportImportId404

export function useGetImportImportId<
  TData = Awaited<ReturnType<typeof getImportImportId>>,
  TError = GetImportImportId404,
>(
  importId: string,
...
export const getGetImportImportIdSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getImportImportId>>,
  TError = GetImportImportId404,
>(
  importId: string,
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getImportImportId>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export type GetImportImportIdSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getImportImportId>>
>
export type GetImportImportIdSuspenseQueryError = GetImportImportId404

export function useGetImportImportIdSuspense<
  TData = Awaited<ReturnType<typeof getImportImportId>>,
  TError = GetImportImportId404,
>(
  importId: string,
