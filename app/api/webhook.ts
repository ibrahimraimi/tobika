 ...
 * Webhook route
 */
export const postCompleteStripeSubscription = (signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/complete-stripe-subscription`, method: 'POST', signal })
}
...
export const usePostCompleteStripeSubscription = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postCompleteStripeSubscription>>,
    TError,
    void,
