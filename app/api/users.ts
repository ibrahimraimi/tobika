 ...
 * Create a user
 */
export const postUsersCreate = (postUsersCreateBody: PostUsersCreateBody, signal?: AbortSignal) => {
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getUsersAvailableUsername>>, TError, TData>
    >
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUsersAvailableUsername>>> = ({
    signal,
  }) => getUsersAvailableUsername(params, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUsersAvailableUsername>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getUsersAvailableEmail>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUsersAvailableEmail>>> = ({ signal }) =>
    getUsersAvailableEmail(params, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUsersAvailableEmail>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getUsersUsername = (username: string, signal?: AbortSignal) => {
  return axiosInstance<GetUsersUsername200>({ url: `/users/${username}`, method: 'GET', signal })
}
...
>(
  username: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUsersUsername>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUsersUsername>>> = ({ signal }) =>
    getUsersUsername(username, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUsersUsername>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getUserById = (id: string, signal?: AbortSignal) => {
  return axiosInstance<GetUserById201>({ url: `/user/by/${id}`, method: 'GET', signal })
}
...
>(
  id: string,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUserById>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
 ...
 */
export const patchUserPassword = (patchUserPasswordBody: PatchUserPasswordBody) => {
...
export const usePatchUserPassword = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof patchUserPassword>>,
    TError,
    { data: PatchUserPasswordBody },
 ...
 */
export const updateUserPreferences = (updateUserPreferencesBody: UpdateUserPreferencesBody) => {
...
export const useUpdateUserPreferences = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateUserPreferences>>,
    TError,
    { data: UpdateUserPreferencesBody },
...
export const getUserPreferences = (signal?: AbortSignal) => {
  return axiosInstance<GetUserPreferences200>({ url: `/user/preferences`, method: 'GET', signal })
}
...
export const getGetUserPreferencesSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getUserPreferences>>,
  TError = unknown,
>(options?: {
  query?: Partial<
    UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUserPreferences>>, TError, TData>
  >
}) => {
  const { query: queryOptions } = options ?? {}
...
export type GetUserPreferencesSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUserPreferences>>
>
export type GetUserPreferencesSuspenseQueryError = unknown

export function useGetUserPreferencesSuspense<
  TData = Awaited<ReturnType<typeof getUserPreferences>>,
  TError = unknown,
>(options: {
  query: Partial<
 ...
 */
export const getUsersSearch = (params: GetUsersSearchParams, signal?: AbortSignal) => {
  return axiosInstance<GetUsersSearch200>({ url: `/users/search`, method: 'GET', params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUsersSearch>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getGetUsersSearchSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getUsersSearch>>,
  TError = unknown,
>(
  params: GetUsersSearchParams,
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUsersSearch>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export type GetUsersSearchSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUsersSearch>>
>
export type GetUsersSearchSuspenseQueryError = unknown

export function useGetUsersSearchSuspense<
  TData = Awaited<ReturnType<typeof getUsersSearch>>,
  TError = unknown,
>(
  params: GetUsersSearchParams,
