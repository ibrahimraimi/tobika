 ...
 * Create a list
 */
export const postList = (postListBody: PostListBody, signal?: AbortSignal) => {
...
export const getPostListMutationOptions = <TError = PostList404, TContext = unknown>(options?: {
...
export const usePostList = <TError = PostList404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postList>>,
    TError,
    { data: PostListBody },
...
export const getLists = (params?: GetListsParams, signal?: AbortSignal) => {
  return axiosInstance<GetLists200>({ url: `/lists`, method: 'GET', params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getLists>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getLists>>> = ({ signal }) =>
...
>(
  params?: GetListsParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getLists>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const deleteListId = (id: string) => {
  return axiosInstance<DeleteListId204>({ url: `/list/${id}`, method: 'DELETE' })
}
...
> => {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteListId>>, { id: string }> = (
    props
  ) => {
    const { id } = props ?? {}
...
export const useDeleteListId = <TError = DeleteListId404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteListId>>,
    TError,
    { id: string },
...
export const getPutListIdMutationOptions = <TError = PutListId404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const usePutListId = <TError = PutListId404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof putListId>>,
    TError,
    { id: string; data: PutListIdBody },
...
export const getListById = (id: string, signal?: AbortSignal) => {
  return axiosInstance<GetListById200>({ url: `/list/by/${id}`, method: 'GET', signal })
}
...
>(
  id: string,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getListById>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getPatchListBannerMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const usePatchListBanner = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof patchListBanner>>,
    TError,
    { data: PatchListBannerBody },
 ...
 * Get list progress
 */
export const getListProgress = (id: string, signal?: AbortSignal) => {
  return axiosInstance<GetListProgress200>({ url: `/list/${id}/progress`, method: 'GET', signal })
}
...
export const getGetListProgressQueryOptions = <
  TData = Awaited<ReturnType<typeof getListProgress>>,
  TError = unknown,
>(
  id: string,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getListProgress>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getListProgress>>> = ({ signal }) =>
    getListProgress(id, signal)
...
export function useGetListProgress<
  TData = Awaited<ReturnType<typeof getListProgress>>,
  TError = unknown,
>(
  id: string,
...
export const getGetListProgressSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getListProgress>>,
  TError = unknown,
>(
  id: string,
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getListProgress>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export type GetListProgressSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getListProgress>>
>
export type GetListProgressSuspenseQueryError = unknown

export function useGetListProgressSuspense<
  TData = Awaited<ReturnType<typeof getListProgress>>,
  TError = unknown,
>(
  id: string,
