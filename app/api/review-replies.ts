 ...
 */
export const postReviewReply = (postReviewReplyBody: PostReviewReplyBody, signal?: AbortSignal) => {
...
export const usePostReviewReply = <TError = PostReviewReply404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postReviewReply>>,
    TError,
    { data: PostReviewReplyBody },
 ...
 * Get review replies
 */
export const getReviewReplies = (params: GetReviewRepliesParams, signal?: AbortSignal) => {
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getReviewReplies>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getReviewReplies>>> = ({ signal }) =>
    getReviewReplies(params, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getReviewReplies>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const deleteReviewReplyById = (id: string) => {
  return axiosInstance<void>({ url: `/review-reply/by/${id}`, method: 'DELETE' })
}
...
export const useDeleteReviewReplyById = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteReviewReplyById>>,
    TError,
    { id: string },
 ...
 */
export const putReviewReplyById = (id: string, putReviewReplyByIdBody: PutReviewReplyByIdBody) => {
...
export const usePutReviewReplyById = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof putReviewReplyById>>,
    TError,
    { id: string; data: PutReviewReplyByIdBody },
