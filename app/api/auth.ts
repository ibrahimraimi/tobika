...
import type { PostLogin200, PostLogin400, PostLoginBody } from './endpoints.schemas'
import { axiosInstance } from '@/services/axios-instance'

/**
 * User login with login and password
 */
export const postLogin = (postLoginBody: PostLoginBody, signal?: AbortSignal) => {
...
export const getPostLoginMutationOptions = <TError = PostLogin400, TContext = unknown>(options?: {
...
export const usePostLogin = <TError = PostLogin400, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postLogin>>,
    TError,
    { data: PostLoginBody },
