 ...
 * Create a review
 */
export const postReview = (postReviewBody: PostReviewBody, signal?: AbortSignal) => {
...
export const getPostReviewMutationOptions = <TError = PostReview404, TContext = unknown>(options?: {
...
export const usePostReview = <TError = PostReview404, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postReview>>,
    TError,
    { data: PostReviewBody },
 ...
 * Get review
 */
export const getReview = (params: GetReviewParams, signal?: AbortSignal) => {
  return axiosInstance<GetReview200>({ url: `/review`, method: 'GET', params, signal })
}
...
>(
  params: GetReviewParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getReview>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getReviews = (params?: GetReviewsParams, signal?: AbortSignal) => {
  return axiosInstance<GetReviews200Item[]>({ url: `/reviews`, method: 'GET', params, signal })
}
...
export function useGetReviews<TData = Awaited<ReturnType<typeof getReviews>>, TError = unknown>(
  params: undefined | GetReviewsParams,
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getReviews>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<
...
>(
  params?: GetReviewsParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getReviews>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export const getDeleteReviewByIdMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const useDeleteReviewById = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteReviewById>>,
    TError,
    { id: string },
 ...
 * Update review by id
 */
export const putReviewById = (id: string, putReviewByIdBody: PutReviewByIdBody) => {
...
export const getPutReviewByIdMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const usePutReviewById = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof putReviewById>>,
    TError,
    { id: string; data: PutReviewByIdBody },
 ...
 */
export const getDetailedReviews = (params?: GetDetailedReviewsParams, signal?: AbortSignal) => {
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getDetailedReviews>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getDetailedReviews>>> = ({ signal }) =>
    getDetailedReviews(params, signal)
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getDetailedReviews>>, TError, TData>
    > &
      Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof getDetailedReviews>>,
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getDetailedReviews>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
