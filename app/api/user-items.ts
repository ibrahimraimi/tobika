...
export const getPutUserItemMutationOptions = <TError = unknown, TContext = unknown>(options?: {
 ...
 * Get user item
 */
export const getUserItem = (params: GetUserItemParams, signal?: AbortSignal) => {
  return axiosInstance<GetUserItem200>({ url: `/user/item`, method: 'GET', params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserItem>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserItem>>> = ({ signal }) =>
...
>(
  params: GetUserItemParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUserItem>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
 ...
 * Get user items
 */
export const getUserItems = (getUserItemsBody: GetUserItemsBody, signal?: AbortSignal) => {
...
export const getGetUserItemsInfiniteQueryOptions = <
  TData = InfiniteData<Awaited<ReturnType<typeof getUserItems>>>,
  TError = unknown,
>(
  getUserItemsBody: GetUserItemsBody,
  options?: {
    query?: Partial<
      UseInfiniteQueryOptions<Awaited<ReturnType<typeof getUserItems>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserItems>>> = ({ signal }) =>
    getUserItems(getUserItemsBody, signal)
...
export function useGetUserItemsInfinite<
  TData = InfiniteData<Awaited<ReturnType<typeof getUserItems>>>,
  TError = unknown,
>(
  getUserItemsBody: GetUserItemsBody,
...
export const getDeleteUserItemIdMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const useDeleteUserItemId = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteUserItemId>>,
    TError,
    { id: string },
 ...
 * Get user items
 */
export const getAllUserItems = (params: GetAllUserItemsParams, signal?: AbortSignal) => {
...
export const getGetAllUserItemsQueryOptions = <
  TData = Awaited<ReturnType<typeof getAllUserItems>>,
  TError = unknown,
>(
  params: GetAllUserItemsParams,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllUserItems>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllUserItems>>> = ({ signal }) =>
    getAllUserItems(params, signal)
...
export function useGetAllUserItems<
  TData = Awaited<ReturnType<typeof getAllUserItems>>,
  TError = unknown,
>(
  params: GetAllUserItemsParams,
...
export const getGetAllUserItemsSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getAllUserItems>>,
  TError = unknown,
>(
  params: GetAllUserItemsParams,
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getAllUserItems>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export type GetAllUserItemsSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAllUserItems>>
>
export type GetAllUserItemsSuspenseQueryError = unknown

export function useGetAllUserItemsSuspense<
  TData = Awaited<ReturnType<typeof getAllUserItems>>,
  TError = unknown,
>(
  params: GetAllUserItemsParams,
