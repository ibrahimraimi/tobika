...
import type { PostImage201, PostImageBody, PostImageParams } from './endpoints.schemas'
...
export const getPostImageMutationOptions = <TError = unknown, TContext = unknown>(options?: {
...
export const usePostImage = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postImage>>,
    TError,
    { data: PostImageBody; params: PostImageParams },
