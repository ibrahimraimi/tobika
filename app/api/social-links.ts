...
export const getPutSocialLinksMutationOptions = <TError = unknown, TContext = unknown>(options?: {
...
export const usePutSocialLinks = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof putSocialLinks>>,
    TError,
    { data: PutSocialLinksBody },
 ...
 */
export const getSocialLinks = (params: GetSocialLinksParams, signal?: AbortSignal) => {
  return axiosInstance<GetSocialLinks200>({ url: `/social-links`, method: 'GET', params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getSocialLinks>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getSocialLinks>>> = ({ signal }) =>
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getSocialLinks>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
