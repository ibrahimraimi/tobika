 ...
 * Follow user
 */
export const postFollow = (postFollowBody: PostFollowBody, signal?: AbortSignal) => {
...
export const getPostFollowMutationOptions = <TError = unknown, TContext = unknown>(options?: {
...
export const usePostFollow = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postFollow>>,
    TError,
    { data: PostFollowBody },
 ...
 * Get follow
 */
export const getFollow = (params: GetFollowParams, signal?: AbortSignal) => {
  return axiosInstance<GetFollow200>({ url: `/follow`, method: 'GET', params, signal })
}
...
export const getGetFollowQueryOptions = <
  TData = Awaited<ReturnType<typeof getFollow>>,
  TError = unknown,
>(
  params: GetFollowParams,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getFollow>>> = ({ signal }) =>
    getFollow(params, signal)
...
export function useGetFollow<TData = Awaited<ReturnType<typeof getFollow>>, TError = unknown>(
  ...
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>,
        'initialData'
      >
  }
...
export function useGetFollow<TData = Awaited<ReturnType<typeof getFollow>>, TError = unknown>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>> &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>,
        'initialData'
      >
  }
...
export const getGetFollowSuspenseQueryOptions = <
  TData = Awaited<ReturnType<typeof getFollow>>,
  TError = unknown,
>(
  params: GetFollowParams,
  options?: {
    query?: Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof getFollow>>, TError, TData>>
  }
) => {
  const { query: queryOptions } = options ?? {}
...
export function useGetFollowSuspense<
  TData = Awaited<ReturnType<typeof getFollow>>,
  TError = unknown,
>(
  params: GetFollowParams,
 ...
 * Delete follow
 */
export const deleteFollow = (deleteFollowBody: DeleteFollowBody) => {
  return axiosInstance<void>({
    url: `/follow`,
    method: 'DELETE',
    headers: { 'Content-Type': 'application/json' },
...
export const getDeleteFollowMutationOptions = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export const useDeleteFollow = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteFollow>>,
    TError,
    { data: DeleteFollowBody },
 ...
 * Get followers
 */
export const getFollowers = (params?: GetFollowersParams, signal?: AbortSignal) => {
  return axiosInstance<GetFollowers200>({ url: `/followers`, method: 'GET', params, signal })
}
...
>(
  ...
  options?: {
    query?: Partial<
      UseInfiniteQueryOptions<Awaited<ReturnType<typeof getFollowers>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
...
>(
  ...
  options: {
    ...
    > &
      Pick<
        DefinedInitialDataOptions<Awaited<ReturnType<typeof getFollowers>>, TError, TData>,
        'initialData'
      >
  }
...
>(
  ...
  options?: {
    ...
    > &
      Pick<
        UndefinedInitialDataOptions<Awaited<ReturnType<typeof getFollowers>>, TError, TData>,
        'initialData'
      >
  }
