...
export const usePostUserEpisodes = <TError = PostUserEpisodes409, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postUserEpisodes>>,
    TError,
    { data: PostUserEpisodesBodyItem[] },
 ...
 * Get user episode
 */
export const getUserEpisodes = (params: GetUserEpisodesParams, signal?: AbortSignal) => {
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getUserEpisodes>>, TError, TData>>
  }
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserEpisodes>>> = ({ signal }) =>
...
>(
  ...
  options?: {
    query?: Partial<
      UseSuspenseQueryOptions<Awaited<ReturnType<typeof getUserEpisodes>>, TError, TData>
    >
  }
) => {
  const { query: queryOptions } = options ?? {}
 ...
 */
export const deleteUserEpisodes = (deleteUserEpisodesBody: DeleteUserEpisodesBody) => {
...
export const useDeleteUserEpisodes = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteUserEpisodes>>,
    TError,
    { data: DeleteUserEpisodesBody },
