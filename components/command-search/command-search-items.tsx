import type { MovieWithMediaType, PersonWithMediaType, TvSerieWithMediaType } from '@/services/tmdb'
...
import type { GetUsersSearch200UsersItem } from '@/app/api/endpoints.schemas'
