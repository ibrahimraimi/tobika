      ...
      <section className="mx-auto max-w-6xl space-y-8 px-4 lg:px-0">
        <div className="mx-auto flex w-full flex-col items-center space-y-4 max-w-xl">
          <h2 className="text-center text-2xl lg:text-5xl font-normal">
            ...
            <span className="relative font-bold">{dictionary.perfect_plan}</span>{' '}
            {dictionary.for_you}
          </h2>

          <p className="text-center text-md text-muted-foreground">{dictionary.explore_features}</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 mx-auto">
          <ol className="max-w-4xl grid-col-1 grid gap-8 lg:grid-cols-2 lg:gap-4">
            <Price.Root>
              <Price.Content>
                <Price.Header>
                  <Price.Label>{dictionary.home_prices.free_plan.title}</Price.Label>

                  <Price.Value>{dictionary.home_prices.free_plan.price}</Price.Value>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Avatar className="mr-2 h-6 w-6 border border-muted-foreground text-[10px]">
                            ...
                            <AvatarFallback className="bg-foreground">{initial}</AvatarFallback>
                          </Avatar>
                        </TooltipTrigger>
            ...
            <Price.Root className="relative">
              ...
              <Price.Content>
                <Price.Header>
                  <Price.Label>{dictionary.home_prices.pro_plan.title}</Price.Label>

                  <Price.Value className="flex items-center gap-2">
                    {dictionary.home_prices.pro_plan.price}
                    <Badge variant="outline">{dictionary.home_prices.pro_plan.recommended}</Badge>
                  </Price.Value>
