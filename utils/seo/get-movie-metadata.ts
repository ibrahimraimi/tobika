...
export async function getMovieMetadata(id: number, language: Language): Promise<Metadata> {
  const { title, overview, backdrop_path, original_title, vote_average, release_date } =
